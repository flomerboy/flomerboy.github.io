$(document).ready(function(){
	...
	bannerHeight = $("#banner").height() - 48	; // This makes sure that it finds out the height of the banner when the page loads, so that on different size monitors it still switches at the right time.
